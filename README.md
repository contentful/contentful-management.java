...
For agents and new contributors, the following documents provide structured context for working safely in this repo:

| Document | Purpose |
|---|---|
| [AGENTS.md](./AGENTS.md) | Agent-first guide: sharp edges, invariants, quick reference — read this first |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Internal structure, module/service pattern, data flow, key dependencies |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | Dev setup, testing, code style, branch and release workflow |
| [docs/ADRs/](./docs/ADRs/) | Architecture Decision Records explaining why things look the way they do |
| [docs/specs/](./docs/specs/) | Implementation specs for active and recent work |
| [.bito/guidelines/](./.bito/guidelines/) | Automated code review rules and domain invariants |
