...
public class ModuleOrganizationUsage extends AbsModule<ServiceOrganizationUsage> {
     ...
     * @return {@link CMAOrganizationUsage} result instance
     */
    public CMAArray<CMAOrganizationUsage> fetchAll(
    ...
    public class Async {
         ...
         * @return {@link CMAOrganizationUsage} result callback.
         */
        public CMACallback<CMAArray<CMAOrganizationUsage>> fetchAll(
                String organizationId,
                Map<String, String> query,
                CMACallback<CMAArray<CMAOrganizationUsage>> callback) {
            return defer(new RxExtensions.DefFunc<CMAArray<CMAOrganizationUsage>>() {
                @Override
                CMAArray<CMAOrganizationUsage> method() {
