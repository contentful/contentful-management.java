...
class ClientTests : BaseTest() {
    ...
    fun failsSetNullClientProvider() {
        try {
            ...
            assertEquals("Cannot call setClientProvider() with null value.", e.getMessage())
            throw e
        }
    }
    ...
    fun failsSetNullLogLevel() {
        try {
            ...
            assertEquals("Cannot call setLogLevel() with null value.", e.getMessage())
            throw e
        }
    }
    ...
    fun failsSetNullEndPoint() {
        try {
            ...
            assertEquals("Cannot call setEndPoint() with null value.", e.getMessage())
            throw e
        }
    }
}